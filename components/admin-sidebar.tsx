      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-foreground/10">
          ...
          <button
            ...
            className="hidden lg:block text-xs opacity-70 hover:opacity-100 transition"
          ...
          <button
            onClick={onClose}
            className="lg:hidden text-xs opacity-70 hover:opacity-100 transition"
        ...
        <div className="flex flex-col items-center px-4 py-6 border-b border-foreground/10 gap-3">
          ...
          {!collapsed && (
            <>
              ...
              <span className="text-xs opacity-70 truncate max-w-full text-center">
                {email}
              </span>
            </>
          )}
